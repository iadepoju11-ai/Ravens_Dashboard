...
def test_train_and_evaluate_logistic_regression(toy_df):
    pipeline = train_logistic_regression(toy_df, NUMERIC_COLUMNS, CATEGORICAL_COLUMNS)
    metrics = evaluate(pipeline, toy_df, NUMERIC_COLUMNS, CATEGORICAL_COLUMNS)
...
def test_train_and_evaluate_xgboost(toy_df):
    pipeline = train_xgboost(toy_df, NUMERIC_COLUMNS, CATEGORICAL_COLUMNS)
    metrics = evaluate(pipeline, toy_df, NUMERIC_COLUMNS, CATEGORICAL_COLUMNS)
